...
public class SinhVienService {
	...
	// mandatory 1 tran nằm trong 1trans khác. khi nó rollback thì thằng bên ngoài cũng rollback
	// nested 1 tran nằm trong 1 tran khác nhưng khi nó rollback không ảnh hưởng đến bên ngoài
